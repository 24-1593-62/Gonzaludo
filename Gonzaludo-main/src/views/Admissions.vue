  ...
  <div class="page">
    <header class="hero">
      <div class="container">
        ...
        <button class="primary-btn">Start Your Application</button>
      </div>
    </header>
    ...
    <main class="container main">
        ...
        <div class="requirements-grid">
          ...
          <div>
            ...
            <ul>
              <li>Lorem ipsum dolor sit amet</li>
              <li>Consectetur adipiscing elit</li>
              <li>Praesent commodo cursus</li>
              <li>Integer posuere erat</li>
            </ul>
          </div>
      ...
      <section class="card">
        ...
        <p class="muted">
          Select your program and year level to estimate your fees.
        </p>
...
const program = ref('BS Information Technology')
const year = ref('3rd Year')
const units = ref(31)
const payment = ref('Full')
</script>
