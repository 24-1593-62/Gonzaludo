  ...
  <nav class="navbar">
    <div class="brand">
      ...
      <div class="school-name">
        <h2>University of Peter Parker</h2>
        <p>alo alo T h u n d e r</p>
      </div>
    </div>
    ...
    <div class="nav-links">
      ...
      <router-link to="/portal-login">Portal Login</router-link>
      <router-link to="/sample-data">Sample Data</router-link>
      <router-link to="/sample-methods">Sample Methods</router-link>
      <router-link to="/sample-vmodel">Sample VModel</router-link>
...
.portal-btn {padding: 10px 18px;
background: #0056b3;
color: white !important;
border-radius: 6px;}

.portal-btn:hover {background: #003d80;}
</style>